...
async def seed_db():
    ...
    async with async_session() as session:
        ...
        for name, slug, desc, url in brands_data:
            brand = Brand(
                name=name, slug=slug, description=desc, website_url=url, is_active=True
            )
            session.add(brand)
            await session.flush()
        ...
        categories_data = [
            ...
            (
                "Gaming",
                "gaming",
                "Consoles, controllers, and headsets",
                "https://images.unsplash.com/photo-1385846819330-ff5685a5324c?w=400",
            ),
            (
                "Cameras",
                "cameras",
                "DSLRs, action cameras, lenses",
                "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400",
            ),
            (
                "Home Appliances",
                "home-appliances",
                "Vacuum cleaners, air purifiers, coffee makers",
            ...
            (
                "Books & Stationery",
                "books-stationery",
                "E-readers, journals, fountain pens",
                "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=400",
            ),
            (
                "Sports & Outdoors",
                "sports-outdoors",
                "Gym gear, bags, and hydration tumblers",
        ...
        products_templates = [
            ...
            (
                ...
                "gaming",
                "logitech",
                "https://images.unsplash.com/photo-1629429408209-1f912961dbd8?w=400",
                False,
            ),
            (
            ...
            (
                ...
                "cameras",
                "sony",
                "https://images.unsplash.com/photo-1616440347437-b1c73416efc2?w=400",
                True,
            ),
            (
            ...
            (
                ...
                "home-appliances",
                "samsung",
                "https://images.unsplash.com/photo-1571175487198-78b8537c2293?w=400",
                True,
            ),
            (
            ...
            (
                ...
                "office-furniture",
                "logitech",
                "https://images.unsplash.com/photo-1632292224971-0d45778b3002?w=400",
                False,
            ),
        ...
        for (
            ...
            # Inventory
            p_inv = Inventory(
                product_id=prod.id, quantity=50, warehouse_location="Warehouse Grid A"
            )
